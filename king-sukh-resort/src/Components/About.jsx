...
const AboutUs = () => {
    ...
    return (
        <div  id="about" className="flex flex-col md:flex-row items-center justify-center p-6 md:p-12 bg-gray-50 min-h-screen">
            {/* Image Section */}
            ...
            <div className="w-full md:w-1/2 p-4 text-center md:text-left">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-4"  data-aos="fade-up">
                    The Best Holidays Start Here!
                </h1>
                <p className="text-gray-600 mb-3"  data-aos="fade-up">
                ...
                <button className="bg-pink-500 text-white font-semibold py-2 px-6 rounded-lg hover:bg-pink-600 transition duration-200"  data-aos="fade-up" onClick={handleBookNowClick}>
                    BOOK NOW
                </button>
            </div>
        </div>
